...
public class EntityTest {
    ...
    public void testCollision() {
        ...
        assertTrue(entity1.checkCollision(entity2), "Entities should be colliding");
    }
    ...
    public void testNoCollision() {
        ...
        assertFalse(entity1.checkCollision(entity2), "Entities should not be colliding");
    }
    ...
    public void testEdgeCollision() {
        ...
        assertFalse(entity1.checkCollision(entity2), "Entities should not be colliding at edges");
    }
    ...
    public void testCornerCollision() {
        ...
        assertTrue(entity1.checkCollision(entity2), "Entities should be colliding at corner");
    }
    ...
    public void testInsideCollision() {
        ...
        assertTrue(entity1.checkCollision(entity2), "One entity is inside the other, they should be colliding");
    }
    ...
    public void testNegativeCoordinates() {
        ...
        Entity entity2 = new MockEntity(-5, -5, new CollisionBox(10, 10));
        assertTrue(entity1.checkCollision(entity2), "Entities with negative coordinates should be colliding");
    }
    ...
    public void testZeroSize() {
        ...
        Entity entity2 = new MockEntity(5, 5, new CollisionBox(10, 10));
        assertFalse(entity1.checkCollision(entity2), "Entity with zero size should not collide");
    }
}
